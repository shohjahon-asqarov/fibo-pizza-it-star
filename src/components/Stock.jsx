        ...
        <section>
            <div className="container py-20">
                ...
                <div className='grid md:grid-cols-2 gap-3 md:gap-8 py-10'>
                    <img data-aos="zoom-in" className='w-full h-full rounded-20' src={stock_img} alt="stock" />

                    <div className='grid grid-cols-2 gap-3 md:gap-8'>
                        <img data-aos="zoom-in" className='rounded-20 h-full' src={stock_img} alt="stock" />
                        <img data-aos="zoom-in" className='rounded-20 h-full' src={stock_img} alt="stock" />
                        <img data-aos="zoom-in" className='rounded-20 h-full' src={stock_img} alt="stock" />
                        <img data-aos="zoom-in" className='rounded-20 h-full' src={stock_img} alt="stock" />
                    </div>
